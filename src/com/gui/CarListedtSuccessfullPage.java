...
public class CarListedtSuccessfullPage {
...
public static void start(final Mediator mediator) {
	EventQueue.invokeLater(new Runnable() {
		public void run() {
			try {
				CarListedtSuccessfullPage window = new CarListedtSuccessfullPage(mediator);
...
*/
public CarListedtSuccessfullPage(final Mediator mediator) {
	initialize(mediator);
}
...
private void initialize(final Mediator mediator) 
{
	...
	JLabel lblSdsdsadsad = new JLabel("You car is successfully Listed !!! ");
